...
HD_PWD='C:/PSUProj/ece361f18/pep9Verilog/sim/pep9Verilog/pep9Verilog.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Pep9CPU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_Pep9CPU.tcl
