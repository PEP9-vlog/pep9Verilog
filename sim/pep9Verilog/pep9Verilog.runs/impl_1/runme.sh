...
HD_PWD='C:/PSUProj/ece361f18/pep9Verilog/sim/pep9Verilog/pep9Verilog.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Pep9CPU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_Pep9CPU.tcl -notrace
